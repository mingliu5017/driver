...
#define USE_CUSTOMER_VOL
#ifdef USE_CUSTOMER_VOL
static const DECLARE_TLV_DB_SCALE(mvol_tlv, -12700, 50, 0);

static const struct snd_kcontrol_new tfa98xx_snd_controls[] =
{
	SOC_SINGLE_TLV("Master Playback Volume", 0x51/*TFA9894_BF_VOL*/, 8/*0*/, 0xfe, 1, mvol_tlv)
	//SOC_SINGLE("Master Playback Volume", DDX_MASTER_VOLUME, 0, 0x64, 1)
};
#endif
